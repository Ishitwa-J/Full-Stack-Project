...
<div style="color: white; margin-left: 60px; font-size: 30px;text-align: center;">
  ...
  <div class="h"><a href="request.php">Books Requested</a></div>
  ...
  document.body.style.backgroundColor = "white";
	...
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #c5882299;" type="submit" name="submit" class="btn btn-default">
...
<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #c5882299;" type="submit1" name="submit1" class="btn btn-default">
					Request
				</button>
		</form>
	</div>
