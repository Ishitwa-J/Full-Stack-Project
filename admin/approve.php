...
<div id="main">
  ...
  <span style="font-size:30px;color: white; cursor:pointer" onclick="openNav()">&#9776; open</span>
    ...
    <form class="Approve" action="" method="post">
        <input class="form-control" type="text" name="approved" placeholder= "Yes or No" required=""><br>
...
<?php
  ...
  {
    mysqli_query($db,"UPDATE  `issue_book` SET  `approved` =  '$_POST[approved]', `issue` =  '$_POST[issue]', `return` =  '$_POST[return]' WHERE username='$_SESSION[name]' and bid='$_SESSION[bid]';");
