...
<section>
	<div class="log_img" style="height: 900px;">
		<br><br>
		<div class="box1">
			...
			<p style="color: white;padding-left: 15px;">
				<br><br>
				<a style="color:white;" href="update_password.php">Forgot password?</a> <br><br>
...
if(isset($_POST['submit']))
{
	...
	if($count==0)
	{
		?>
			...
			-->
			<div class="alert alert-danger" style="width: 700px; margin-left: 320px;margin-top: -400px;background-color: ;">
